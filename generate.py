...
if __name__ == '__main__':
    ...
    parser.add_argument('--context_len', default=200, type=int, required=False, help='每一步生成时，参考的上文的长度')
    parser.add_argument('--max_len', default=300, type=int, required=False, help='生成的最长长度')
    parser.add_argument('--log_path', default='log/moral.log', type=str, required=False, help='日志存放位置')
    parser.add_argument('--no_cuda', action='store_true', help='不使用GPU进行预测')
    # parser.add_argument('--model_path', type=str, default='/home/omnisky/data2/data/wxx/Models/CPM-large/epoch9', help='模型存放位置')
    parser.add_argument('--model_path', type=str, default='./CPM-large', help='模型存放位置')
    # parser.add_argument('--title', type=str, default='鹦鹉与麻雀', help='作文标题')
    # parser.add_argument('--context', type=str, default='', help='作文上文')
    ...
    # title_list = []
    # context_list = []
    # # f=open('/home/omnisky/data2/data/wxx/GLM-4/data/CCStory/test.txt','r',encoding='utf-8')
    # f=open('/home/omnisky/data2/data/wxx/GLM-4/data/offensive.txt','r',encoding='utf-8')
    # save_path = open('Moral_offen.txt', 'w')
    # i=0
